    ...
    <section class="container-menu-food">
        <nav id="fn" class="menu-nav food-nav">
            <ul>
                ...
                <li><a href="panirana.php">Panirana jela</a></li>
                <li><a id="highlightfood" href="sendvici.php">Sendviči</a></li>
            </ul>
        </nav>
    </section>
    <section class="container-items">
        <h2 class="section-header">SENDVIČI</h2>
