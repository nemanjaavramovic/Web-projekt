    ...
    <body>
        ...
        <header class="container-menu">
            ...
            <nav class="menu-nav food-nav" id="mv">
                <ul id="fm">
                    ...
                    <li><a id="highlightmenu" href="odbij.php">Odbijene narudžbe</a></li>
        ...
        <?php
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT id, first_name, last_name, email, telephone_number, street, city, order_list, confirmation  FROM narudzba WHERE confirmation='odbijena'"); 
                $stmt->execute();
