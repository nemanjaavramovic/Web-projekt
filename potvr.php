...
<html>
<head>
    <title>Potvrđene narudžbe</title>
    <meta charset="UTF-8">
    ...
    <body>
        ...
        <?php
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT id, first_name, last_name, email, telephone_number, street, city, order_list, confirmation  FROM narudzba WHERE confirmation='potvrdjena'"); 
                $stmt->execute();
